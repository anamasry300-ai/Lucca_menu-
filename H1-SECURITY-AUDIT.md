...
|---|---|---|
| `index.html:2970` | حرفي `|| '[REDACTED]'` | دفع background بعد الطلب |
| `index.html:4839` | `localStorage.luccaApiKey || '[REDACTED]'` | قائمة أعمال غير المتزامن |
| `index.html:1714` | يعرض `data.apiKey` | نص `testServerConnection` (قتيل منذ H2) |
| `admin/database.js:2552,2604,2719` | `localStorage.luccaApiKey || '[REDACTED]'` | pushAll / pullAll / testConnection |
...
- **يُستخرج من DevTools** ومن **كود المصدر** (الحرفي `[REDACTED]`).
